...
#define PYGAME_ENDPOINT_STYLE_MITER_ROUND 0x4
    DEC_CONSTS(ENDPOINT_STYLE_DEFAULT, PYGAME_ENDPOINT_STYLE_DEFAULT);
    DEC_CONSTS(ENDPOINT_STYLE_RECT, PYGAME_ENDPOINT_STYLE_RECT);
    DEC_CONSTS(ENDPOINT_STYLE_ROUND, PYGAME_ENDPOINT_STYLE_ROUND);
    DEC_CONSTS(ENDPOINT_STYLE_MITER_RECT, PYGAME_ENDPOINT_STYLE_MITER_RECT);
    DEC_CONSTS(ENDPOINT_STYLE_MITER_ROUND, PYGAME_ENDPOINT_STYLE_MITER_ROUND);
