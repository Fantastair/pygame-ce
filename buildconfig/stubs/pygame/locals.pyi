...
DROPFILE: int
DROPTEXT: int
ENDPOINT_STYLE_DEFAULT: int
ENDPOINT_STYLE_MITER_RECT: int
ENDPOINT_STYLE_MITER_ROUND: int
ENDPOINT_STYLE_RECT: int
ENDPOINT_STYLE_ROUND: int
FINGERDOWN: int
FINGERMOTION: int
FINGERUP: int
FLASH_BRIEFLY: int
...
__all__ = [
    ...
    "FLASH_BRIEFLY",
    "FLASH_UNTIL_FOCUSED",
    "ENDPOINT_STYLE_DEFAULT",
    "ENDPOINT_STYLE_RECT",
    "ENDPOINT_STYLE_ROUND",
    "ENDPOINT_STYLE_MITER_RECT",
    "ENDPOINT_STYLE_MITER_ROUND",
    "Rect",
    "Color",
]
